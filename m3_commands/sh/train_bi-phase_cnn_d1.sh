#!/bin/bash
#SBATCH --job-name=bi-phase_cnn_d1
#SBATCH --account=sy86
...
#SBATCH --output=../slurm_outputs/bi-phase_cnn_d1_%j.out
#SBATCH --error=../slurm_outputs/bi-phase_cnn_d1_%j.err
...
python src/training/train_bi-phase_flexible.py \
    ...
    --lr 8e-4 \
    --batch_size 64 \
    --load_path pretrained/CNNsingle_phase_D1.pth \
...
echo "Bi-phase CNN training completed!"
