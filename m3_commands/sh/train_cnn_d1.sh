#!/bin/bash
#SBATCH --job-name=cnn_d1_train
#SBATCH --output=/home/ankitag/sy86/ankitag/Ankita_CPICANN_Phase/monash_HPC_commands/slurm_outputs/cnn_d1_train_%j.out
#SBATCH --error=/home/ankitag/sy86/ankitag/Ankita_CPICANN_Phase/monash_HPC_commands/slurm_outputs/cnn_d1_train_%j.err
...
# Run CNN training
python src/training/train_cnn_d1.py \
    --epochs 100 \
    --warmup-epochs 10 \
    --lr 8e-5 \
    --batch_size 64 \
