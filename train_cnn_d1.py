#!/usr/bin/env python3
"""
Training script for CNN-only model on D1_full dataset
Based on train_single-phase.py but modified for CNN architecture
"""
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='CNN Training on D1_full Dataset')
    ...
    parser.add_argument('--model_name', default='CNN_D1_full', type=str)
    ...
    # Initialize model
    model = CNN(embed_dim=args.embed_dim, num_classes=args.num_classes)
    model.to(device)
