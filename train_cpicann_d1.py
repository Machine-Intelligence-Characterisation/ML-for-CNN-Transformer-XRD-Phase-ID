#!/usr/bin/env python3
"""
Training script for CPICANN model on D1_full dataset
Modified version of train_single-phase.py for D1_full dataset
"""
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='CPICANN Training on D1_full Dataset')
    ...
    parser.add_argument('--model_name', default='CPICANN_D1_full', type=str)
    ...
    # Initialize model
    model = CPICANN(embed_dim=args.embed_dim, num_classes=args.num_classes)
    model.to(device)
